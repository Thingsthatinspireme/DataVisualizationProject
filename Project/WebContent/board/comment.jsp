        ...
        <div id="comments" style="margin-top:100px;">
            ...
            <form action='comment.do?blno=${blno}&cno=${cno}' method='post'>
               <div style="margin-bottom : 50px;" class="comment-row">
                 ...
                 <button style="float:right;"class="btn" type="submit" onClick="SubmitComment();">���</button>
               </div>
                 <hr/>
            </form>
            </div>
 		...
 		<c:forEach var="commentList" items="${commentList}">
 		    <div class="comment-row">
 		      <c:if test="${commentList.id eq loginId}">
    			<button class="btn" onclick='location.href="${pageContext.request.contextPath}/comment-delete.do?blno=${blno}&comno=${commentList.comno}&cno=${commentList.cno}"'>����</button>
              ...
              <form action='${pageContext.request.contextPath}/comment-update.do?blno=${blno}&comno=${commentList.comno}&cno=${commentList.cno}' method='post'>
               <input class="update" id="update${commentList.comno}" type="button" onclick="commentCheck(${commentList.comno}, ${commentList.cno}, '${commentList.comment}');" value="����"/>
               </c:if>
